...
def create_publication(publication: Publication) -> JSONResponse:
    ...
    return JSONResponse(status_code=201, content={"message": "The publication was created", "data": jsonable_encoder(publication)})
...
def update_publication(id: int, publication: Publication) -> JSONResponse:
    ...
    return JSONResponse(status_code=200, content={"message": "The publication was updated", "data": jsonable_encoder(new_publication)})
